...
class ITSConstantValues():
    ...
    def create_gtin_sn(self):
        ...
        matrix = pandas.read_excel("Excels\gtin-sn.xlsx").as_matrix()
    ...
    def create_gtin(self):
        ...
        excel = xlrd.open_workbook("Excels\gtin.xlsx")
        excelsheet = excel.sheet_by_index(0)
    ...
    def create_gln(self):
        ...
        excel = xlrd.open_workbook("Excels\gln.xlsx")
        excelsheet = excel.sheet_by_index(0)
    ...
    def create_pres_id(self):
        ...
        array = pandas.read_excel("Excels\prescription_record_number.xlsx")
    ...
    def create_notification_id(self):
        ...
        array = pandas.read_excel("Excels\\notificationID.xlsx")
